...
public class BanHangController {
    ...
    public ResponseEntity<?> createHoaDon(@RequestBody HoaDonReq req) {
        ...
        try {
            ...
            chiTietHoaDon.setSoLuong(0);
            chiTietHoaDon.setGiaBan("0");

            chiTietHoaDonRepo.save(chiTietHoaDon);
            chiTietHoaDonRepo.findAll();

            return ResponseEntity.ok().body(Map.of("message", "Thêm hóa đơn và chi tiết hóa đơn thành công!", "hoaDon", savedHoaDon));
