...
public class HinhThucHoaDonRequest {
    ...
    private String ngayTao; // Có thể cần chuyển đổi sang Date nếu bạn xử lý ngày ở lớp dịch vụ

    private String ngayThanhToan; // Tương tự như trên
    ...
    private String ngayCapNhat; // Tương tự như trên
